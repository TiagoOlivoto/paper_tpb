...
# Rater effect on palette selection
...
ggsave("figs/eps_fig3_estimates.eps", width = 10, height = 6)
```
...
ggpairs(df_ggpairs,
  ...
  theme(panel.spacing = unit(0, "cm"), 
        ...
        legend.title = element_blank())
ggsave("figs/fig4_softwares.jpg", dpi = 600)
ggsave("figs/eps_fig4_softwares.eps")
```
...
severity <- mutate(severity,
                   resolution = fct_relevel(resolution, "1367x2160", "1020x1620", "680x1078", "510x808", "170x270"))
...
ggsave("figs/eps_fig5_resolution.eps")
```


# Computation time
```{r runningtime, fig.width=3.5, fig.height=2.8}
...
ggsave("figs/eps_fig6_runningtime.eps",
       width = 12,
       height = 9,
       units = "cm")
```
